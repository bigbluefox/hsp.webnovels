            ...
            <div class="modal-content">\
                <div class="modal-body">\
                    <div class="row" style="padding-left:20px; height:42px;line-height:42px;">\
                        ...
                        <h4 style="display: block; float:left; padding-left: 10px;">' + title + "</h4>\
                    </div>\
                </div>\
            </div>\
        </div>");
...
(function ($, window, document, undefined) {
    ...
    function modalStructure(config, ok, cancel) {
    ...
    function createModal(config, ok, cancel) {
        removeModal();

        var modal = modalStructure(config, ok, cancel);
    ...
    function _alert(args, type) {
        ...
        return createModal(cfg, false, true);
    }
    ...
    modals.confirm = function () {
        ...
        return createModal(cfg, true, true);
    };

    modals.popup = function (cfg) {
        return createModal(cfg || {}, false, false);
    };
